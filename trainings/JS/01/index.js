//Describe what is JavaScript.
//JavaScript es un lenguaje de programación echo para sitios web.

//Describe what is ES (EcmaScript).
//ES es una forma de darle mejor funcionalidad a nuestro codigo y también trajo actualizaciones
...
//Create one variable with const called nameConst and set your name

const nameConst = 'Andres';
console.log(nameConst);

//Create one variable with var called nameVar and set your name

var nameVar = 'Andres';
console.log(nameVar);

//Create one variable with let called age without value
