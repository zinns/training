...
const listPokemon = pokemon => {
  ...
  container.classList.add('rounded-lg', 'flex', 'flex-col', 'relative');

  container.innerHTML = `
  <div
  id="card"
  class="rounded-lg w-full flex flex-col h-full gap-2"
>
<div id="blur-card"></div>
<div id="card-container" class="p-2">
...
<div class="w-full h-72 relative z-10">
<img id="image"
  class="w-full h-80 absolute top-3  z-10"
...
<div class="w-full flex justify-between">
  <div class="flex flex-col text-white text-2xl">
    ...
    <span id="type" class="pl-7 font-nunito font-thin relative z-30">Electric</span>
  </div>
...
<div class="w-full flex gap-6 text-white">
  <div class="flex flex-col">
    ...
    <span id="data-base" class="pl-3 font-nunito font-thin">Defense</span>
    <span id="data-base" class="pl-3 font-nunito font-thin">Special-attack</span>
    <span id="data-base" class="pl-3 font-nunito font-thin">Speed</span>
  </div>
