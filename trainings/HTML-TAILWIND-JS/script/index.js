...
const listPokemon = pokemon => {
  ...
  <div class="card-container w-full h-full p-2 relative top-0 left-0">
    ...
    <div class="image w-64 h-56 relative z-10">
      <img
        class="w-full h-64 absolute top-10 left-5 z-40 overflow-visible"
    ...
    <div class="w-full flex justify-between relative -top-3">
      ...
      <div class="flex flex-col text-white items-center">
        <span id="like" class="cursor-pointer relative z-50">
          <svg
            width="23"
            height="20"
            viewBox="0 0 23 20"
        ...
        <span id="caught" class="cursor-pointer relative z-50 pl-3">
          <svg
            width="43"
            height="42"
            viewBox="0 0 43 42"
